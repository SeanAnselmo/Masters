...
\NormalTok{Q5b }\OtherTok{=} \FunctionTok{integrate}\NormalTok{(PX, }\AttributeTok{lower =} \DecValTok{4}\NormalTok{, }\AttributeTok{upper =} \DecValTok{15}\NormalTok{)}\SpecialCharTok{$}\NormalTok{value}
...
\NormalTok{\}}
\NormalTok{Q5c }\OtherTok{=} \FunctionTok{integrate}\NormalTok{(EVpx, }\AttributeTok{lower =} \DecValTok{0}\NormalTok{, }\AttributeTok{upper=}\DecValTok{100}\NormalTok{)}\SpecialCharTok{$}\NormalTok{value}
...
\NormalTok{\}}
\NormalTok{variance }\OtherTok{=} \FunctionTok{integrate}\NormalTok{(m2, }\AttributeTok{lower =} \DecValTok{0}\NormalTok{, }\AttributeTok{upper =} \DecValTok{100}\NormalTok{)}\SpecialCharTok{$}\NormalTok{value}
...
\NormalTok{Q5e }\OtherTok{=}  \FunctionTok{integrate}\NormalTok{(PX, }\AttributeTok{lower =}\NormalTok{ lower\_bound, }\AttributeTok{upper =}\NormalTok{ upper\_bound)}\SpecialCharTok{$}\NormalTok{value}
\end{Highlighting}
\end{Shaded}
